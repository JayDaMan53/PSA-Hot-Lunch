if (!document.getElementById("PSA-AutoFill")) {
	...
	chrome.storage.local.get(["SettingSave"], function(SaveData) {
		...
		if (SaveData.SettingSave[5] == 0) {
			...
			div.id = "PSA-AutoFill"
			div.innerHTML = '<style id="PSAStyle"> .box { border: 0.5px solid rgb(255, 255, 255); border-radius: 10px; padding: 10px; box-shadow: 3px 3px 5px #555; position: fixed; left: 5%; top: 80%; width: 120; color: white; font-weight: bold; background-color: rgb(0, 0, 0); } .aaa:hover { cursor: pointer; } #text-container { display: inline-block; margin-left: 10px; vertical-align: top; } #Lunch, #next-lunch { display: block; } </style> <div class="box" id="PSAPhotoBox"> <img id="PSAPhoto" src="https://i.ibb.co/QCFMyx3/icon128.jpg" alt="Fill-PSA" width="75" height="75"><div id="text-container"> <b style="font-size: 5;" id="Lunch">Loading...</b><p style="font-size: 1;"></p><b style="font-size: 5;" id="next-lunch">Loading...</b> </div> <img src="https://i.ibb.co/QCjKgXt/X.webp" alt="Fill-PSA" width="25" height="25" style="position: absolute; top: 85px; left: 240px;" title="Please set up auto-fill in the settings" id="Disabled/Enabled"></div>';
			...
			var div = document.createElement('div');
			div.id = "PSA-AutoFill"
			div.innerHTML = '<style id="PSAStyle"> .box { border: 0.5px solid rgb(255, 255, 255); border-radius: 10px; padding: 10px; box-shadow: 3px 3px 5px #555; position: fixed; left: 5%; top: 80%; width: 120; color: white; font-weight: bold; background-color: rgb(0, 0, 0); } #text-container { display: inline-block; margin-left: 10px; vertical-align: top; } #Lunch, #next-lunch { display: block; } </style> <div class="box" id="PSAPhotoBox"> <img id="PSAPhoto" src="https://i.ibb.co/QCFMyx3/icon128.jpg" alt="Fill-PSA" width="75" height="75"><div id="text-container"> <b style="font-size: 5;" id="Lunch">Loading...</b><p style="font-size: 1;"></p><b style="font-size: 5;" id="next-lunch">Loading...</b> </div></div>';
			document.body.appendChild(div);
